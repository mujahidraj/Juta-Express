...
const Register = () => {
  ...
  return (
    ...
    <div className="h-screen w-full relative flex items-center justify-center overflow-hidden font-sans text-gray-900 bg-gray-900">
      ...
      {/* --- CARD CONTAINER --- */}
      <div className="relative z-10 w-full max-w-4xl bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 mx-4 border border-white/20">
