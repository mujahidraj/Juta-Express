...
const BestSellingCard = ({items}) => {
  ...
  // Helper to map string colors to Tailwind classes (simplified for demo)
  ...
  return (
    <div className="w-full max-w-sm bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 group">
      ...
      <div className="relative  bg-gray-100 overflow-hidden">
        ...
        {/* Product Images (Hover effect or click) */}
        <img 
        ...
        <div className="mb-4">
            ...
            <div className="flex gap-2">
                ...
                <button
                    ...
                    selectedColor === color ? 'border-gray-900 scale-110' : 'border-transparent hover:scale-110'
                    }`}
                >
